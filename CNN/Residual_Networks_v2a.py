...
from keras.initializers import glorot_uniform # keras.initializers.glorot_uniform(seed=None) Glorot uniform initializer, also called Xavier uniform initializer.
import scipy.misc
